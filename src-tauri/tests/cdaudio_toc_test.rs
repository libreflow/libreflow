...
fn parses_three_audio_tracks_plus_leadout() {
    let buf: Vec<u8> = vec![
        ...
        0x00, 0x10, 0x02, 0x00, 0x00, 0x00, 0x4E, 0x20,
        0x00, 0x10, 0x03, 0x00, 0x00, 0x00, 0x9C, 0x40,
        0x00, 0x10, 0xAA, 0x00, 0x00, 0x00, 0xEA, 0x60,
    ];
...
fn filters_data_tracks() {
    let buf: Vec<u8> = vec![
        0x00, 0x1A, 0x01, 0x02,
        0x00, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x14, 0x02, 0x00, 0x00, 0x00, 0x4E, 0x20,
        0x00, 0x10, 0xAA, 0x00, 0x00, 0x00, 0x9C, 0x40,
    ];
    let tracks = parse_toc_lba(&buf).unwrap();
