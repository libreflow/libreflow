...
export default {
  ...
  t_idb_quota_artwork:  'Stockage presque plein — artwork non sauvegardé. Libérez de l\'espace disque.',
  t_idb_quota_critical: 'Stockage plein — données non sauvegardées. Libérez de l\'espace disque immédiatement.',
  ...
  watch_open_settings:  'Dossier surveillé — ouvrir les paramètres',
  sb_stats_open:        'Voir les statistiques',
  ...
  cd_err_auto_folder:       'Impossible de créer le dossier Musique — configurez un dossier manuellement.',
  nav_home:         'Accueil',
  vol_label:        'Volume',
