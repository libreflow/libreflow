// i18n.fr.js — Locale française (source of truth for FR strings)
// Importé par i18n.js pour construire LANGS.fr.
// Nouveaux ajouts : multi_artists, n_albums, dur_min.
...
export default {
  ...
  lib_tab_tracks: 'Titres',
  nav_playlists:  'Playlists',
  sb_group_lib:      'Ma bibliothèque',
  sb_scan_folder:    'Scanner un dossier',
  // Sidebar
  n_tracks:       'titres',
  ...
  // Scan
  scan_title:     'Analyse de ta musique…',
  ...
  lib_play_all:    'Tout lire',
  lib_shuffle_all: 'Lecture aléatoire',
  tr_more:         "Plus d'actions",
  aria_toggle_remaining: 'Basculer durée totale / temps restant',
  srch_ph:        'Rechercher…',
  ...
  empty_cta_explore: 'Explorer la bibliothèque',
  ...
  pl_sort_recent:     'Récentes',
  sort_btn_playlists: 'Trier les playlists',
  sb_pl_grid:         'Parcourir les playlists',
  ...
  pl_hero_edit:     'Modifier la pochette',
  ...
  t_tags_read_error:    'Impossible de lire les tags',
  t_idb_quota_artwork:  'Stockage presque plein — artwork non sauvegardé. Libère de l\'espace disque.',
  t_idb_quota_critical: 'Stockage plein — données non sauvegardées. Libère de l\'espace disque immédiatement.',
  t_idb_write_error:    'Erreur d\'écriture — relancez l\'application si le problème persiste.',
  t_m3u_import_error:   'Erreur lors de l\'import M3U',
  t_smart_readonly:     'Les playlists intelligentes ne peuvent pas être modifiées manuellement.',
  radio_save_error:     'Erreur lors de la sauvegarde',
  ...
  aria_search_toggle: 'Rechercher',
  aria_srch_clear:'Effacer la recherche',
  aria_like:      'Ajouter aux favoris',
  pc_like:        'Ajouter aux favoris',
  aria_pbar:      'Position de lecture',
  aria_vol:       'Volume',
  vol_mute:       'Couper le son',
  vol_unmute:     'Rétablir le son',
  ...
  aria_sel_like:       'Ajouter ou retirer des favoris',
  ...
  aria_cinema_overlay: 'Mode cinéma',
  aria_cinema_pbar:    'Position de lecture (cinéma)',
  aria_cinema_mute:    'Couper le son',
  aria_cinema_queue_toggle: "Afficher la file d'attente",
  aria_cinema_unmute:  'Rétablir le son',
  ...
  t_cinema_mute:       'Couper le son',
  t_cinema_unmute:     'Rétablir le son',
  ...
  motion_system:        'Système',
  motion_full:          'Complètes',
  motion_reduce:        'Réduites',
  ...
  watch_label_default:  'Dossier surveillé',
  sb_resize:            'Redimensionner la barre latérale',
  ...
  queue_empty:          "Aucun titre en file",
  queue_empty_hint:     "Clic droit sur un titre → « Lire ensuite » pour le programmer ici.",
  ...
  sc_search:        'Activer la recherche',
  ...
  sc_zoom_in:       'Zoomer la liste de pistes',
  sc_zoom_out:      'Dézoomer la liste de pistes',
  sc_zoom_reset:    'Réinitialiser le zoom de la liste',
  ...
  set_organize_needs_watch: "Configure d'abord un dossier surveillé — il sert de racine à l'arborescence cible.",
  ...
  cd_err_unreadable:        'CD illisible — vérifie le disque et le lecteur.',
  cd_err_rip:               "Échec de l'extraction du CD — réessayez.",
  cd_auto_folder:           'Dossier Musique créé automatiquement.',
  cd_err_auto_folder:       'Impossible de créer le dossier Musique — configure un dossier manuellement.',
  ...
  set_cinema_waves:    'Vagues animées réactives à la musique',
  set_cinema_starfield:'Ciel étoilé réactif à la musique',
  ...
  set_cinema_waves_label:    'Vagues',
  set_cinema_starfield_label:'Étoiles',
  ...
  radio_regen_need:     'Lance d\'abord un titre pour régénérer la radio',
  radio_regen_done:     (name) => `Radio régénérée depuis « ${name} »`,
  ...
  radio_regen_btn:      'Régénérer',
  radio_save_btn:       'Sauvegarder',
  radio_seed_lbl:       'Titre de départ',
  ...
  cinema_queue_title:    'À suivre',
  cinema_queue_empty:    'Aucune piste prévue',
