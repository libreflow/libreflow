...
export default {
  ...
  wlc_feat1_d:    'Folders, covers and metadata extracted automatically',
  wlc_feat2_t:    'Playlists & Smart Radio',
  wlc_feat2_d:    'Manual playlists, smart playlists and affinity radio',
  ...
  pl_liked_count:  (n) => `${n} liked track${n!==1?'s':''}`,
  pl_sort_label:    'Sort',
  ...
  t_already_imported: 'All files are already in the library',
  ...
  t_recognized:   (n) => `${n} tracks recognized`,
  ...
  watch_open_settings:  'Watched folder — open settings',
  sb_stats_open:        'View statistics',
  ...
  set_export_sub:       'Export the active playlist in M3U format',
