...
export default {
  ...
  // Scan
  scan_title:     'Scanning your music…',
  ...
  lib_play_all:    'Play all',
  lib_shuffle_all: 'Shuffle',
  tr_more:         'More actions',
  aria_toggle_remaining: 'Toggle total duration / time remaining',
  srch_ph:        'Search…',
  ...
  empty_cta_explore: 'Browse the library',
  ...
  queue_empty:          'No tracks queued',
  queue_empty_hint:     'Right-click a track → "Play next" to queue it here.',
