...
//
// NOTE: readTags() (hand-rolled ID3v2/ID3v1/FLAC/M4A binary parser) was removed
// 2026-07 — fully superseded by the Rust-side `read_tags` IPC command
// (see OPT-1 comment in library.js).
...
export { extractColor, guessGenre };
